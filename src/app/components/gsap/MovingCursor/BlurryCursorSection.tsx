...
export default function BlurryCursorSection() {
    ...
    return (
        <>
            ...
            <section
                ref={sectionRef}
                className="relative h-[150vh] w-full overflow-hidden bg-black text-white"
            >
                <div
                    ref={circle}
                    className="absolute rounded-full pointer-events-none bg-radial from-orange-400 from-30% to-black opacity-0 z-20"
                    style={{
                        width: size,
                        height: size,
                    }}
                ...
                <div className="relative z-40 flex items-center justify-center h-full">
                    <div className="h-full w-full flex ">
                        <div className="h-full w-30 bg-background">
                        ...
                        <div className="flex-1 flex-col  ">
                            ...
                            <div className=" flex-1  h-[80%] py-px  ">
                                ...
                                <div className="flex flex-wrap px-px  w-full h-full  ">
                                    ...
                                    {
                                        stackData.map((e, i) => (
                                            <div key={e.id} className="basis-1/4  backdrop-blur-3xl p-px flex flex-col gap-px">
                                                <div className="h-full w-full  bg-primary-foreground/80">
                                                   {/* <div>
