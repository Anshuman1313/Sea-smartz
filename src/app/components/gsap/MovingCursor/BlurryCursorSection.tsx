...
export const stackData: TechStack[] = [
  ...
  },
  {
    ...
    icon: (<svg viewBox="0 0 24 24" fill="none"><path fill="white" d="M3 18l7-14 3 5-6 9z"/><path fill="white" d="M14 4l7 14h-9l2-5-3-4z"/></svg>)
  },
  {
    id: 10,
    title: "Docker",
    description: "A platform for building and deploying containerized applications.",
    icon: (<svg viewBox="0 0 24 24" fill="none"><rect x="3" y="12" width="3" height="3" fill="white"/><rect x="7" y="12" width="3" height="3" fill="white"/><rect x="11" y="12" width="3" height="3" fill="white"/><rect x="11" y="8" width="3" height="3" fill="white"/><path d="M20 14c-.5 2-2 4-6 4H6" stroke="white" strokeWidth="2"/></svg>)
  },
//   {
//     id: 11,
//     title: "Kubernetes",
