...
export const metadata: Metadata = {
  title: 'Privacy Policy | SEA Smartz',
  description: 'Privacy Policy for SEA Smartz - Learn how we collect, use, and protect your personal information',
};
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <section className="mb-12">
            ...
            <div className="bg-card border border-[#ff7700]/30 rounded-lg p-6 mb-6">
              <div className="flex items-start">
                <svg className="w-6 h-6 text-[#ff7700] mt-1 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  ...
                  <p className="text-card-foreground">
                    Protecting your personal information is a top priority at SEA Smartz. We have implemented strict administrative, technical, and physical safeguards to ensure the security of your data.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="mb-12">
            ...
            <div className="bg-muted rounded-lg p-6 mb-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="text-center">
                  <div className="w-12 h-12 bg-card rounded-full flex items-center justify-center mx-auto mb-2 border border-border">
                    <svg className="w-6 h-6 text-[#ff7700]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                  </div>
                  <h4 className="font-medium text-foreground">IP Addresses</h4>
                </div>
                <div className="text-center">
                  <div className="w-12 h-12 bg-card rounded-full flex items-center justify-center mx-auto mb-2 border border-border">
                    <svg className="w-6 h-6 text-[#ff7700]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <h4 className="font-medium text-foreground">Browser Information</h4>
                </div>
                <div className="text-center">
                  <div className="w-12 h-12 bg-card rounded-full flex items-center justify-center mx-auto mb-2 border border-border">
                    <svg className="w-6 h-6 text-[#ff7700]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <h4 className="font-medium text-foreground">User Behavior</h4>
                </div>
              </div>
            </div>
            ...
            <div className="border-l-4 border-[#ff7700] bg-card p-4 rounded-r-lg">
          ...
          <section className="mb-12">
            ...
            <div className="bg-card border border-[#ff7700]/30 rounded-lg p-4">
              <p className="text-card-foreground">
                <strong className="text-[#ff7700]">Important:</strong> Continued use of the website after any changes indicates your acceptance of the updated policy.
              </p>
            </div>
          </section>
